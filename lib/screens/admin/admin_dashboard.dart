        ...
        children: [
          ...
          statsAsync.when(
            ...
            data: (stats) => Column(
              children: [
                ...
                const SizedBox(height: 12),
                _StatCard(
                  title: 'Pending Porutham Requests',
                  value: '${stats['pendingPoruthams'] ?? 0}',
                  icon: Icons.star,
                  color: Colors.purple,
                  onTap: () => context.go('/admin/poruthams'),
                ),
              ],
            ),
          ),
          ...
          GridView.count(
            ...
            children: [
              ...
              _QuickAction('Porutham Queue', Icons.queue, () => context.go('/admin/poruthams')),
            ],
          ),
        ],
      ),
