...
class NotificationNotifier extends Notifier<void> {
  ...
  static String _defaultRoute(AppNotificationEvent e) => switch (e) {
        ...
        AppNotificationEvent.appointmentBooked => '/astrology',
        AppNotificationEvent.appointmentConfirmed => '/astrology',
        AppNotificationEvent.appointmentCancelled => '/astrology',
