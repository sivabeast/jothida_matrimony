      ...
      child: Column(
        ...
        children: [
          ...
          Wrap(
            ...
            runSpacing: 8,
            children: [
              _stat('This Wk Assigned', '${stats.thisWeek.assigned}',
                  Icons.event_available, Colors.teal),
              _stat('This Wk Completed', '${stats.thisWeek.completed}',
                  Icons.done_all, Colors.green),
              _stat('This Wk Pending', '${stats.thisWeek.pending}',
                  Icons.hourglass_bottom, Colors.orange),
              _stat('Last Wk Completed', '${stats.lastWeek.completed}',
